...
class TestXueqiuAndroid(object):
	...
	def test_webview_B(self):
		self.driver.find_element_by_accessibility_id('基金开户').click()
		self.driver.find_element_by_accessibility_id('已有蛋卷基金账户登录').click()

		self.driver.find_element_by_xpath('//*[@text="请输入手机号" and @instance="0"]').send_keys("12312")
		self.driver.find_element_by_xpath('//*[@text="请输入6位验证码" and @instance="1"]').send_keys("123")
